...
if [ $? -ne 0 ]; then
    ...
    mysql -h mysql.jyothiy.online -uroot -pRoboShop@1 < /app/db/schema.sql
    mysql -h mysql.jyothiy.online -uroot -pRoboShop@1 < /app/db/app-user.sql
    mysql -h mysql.jyothiy.online -uroot -pRoboShop@1 < /app/db/master-data.sql
